...
<template>
    <ul class="mt-3 space-y-3 font-medium" :class="{ 'flex flex-col' : hidden }">
        <li class="flex items-center text-gray-400 hover:text-gray-300">
            <!-- <NavLink :href="route('home')" :active="route().current('home')" class="flex items-center text-white"> -->
                ...
                <span class="ml-3" v-show="!hidden">Home</span>
            <!-- </NavLink> -->
        </li>
        <li class="flex items-center text-gray-400 hover:text-gray-300">
            <!-- <NavLink :href="route('users.index')" :active="route().current('users.index')" class="flex items-center text-white"> -->
               <!-- <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                ...
                <span class="ml-3" v-show="!hidden">About Us</span>
            <!-- </NavLink> -->
        </li>
        <li class="flex items-center text-gray-400 hover:text-gray-300">
            <!-- <NavLink :href="route('facilities.index')" :active="route().current('facilities.index')" class="flex items-center text-white"> -->
                ...
                <span class="ml-3" v-show="!hidden">Products</span>
            <!-- </NavLink> -->
        </li>
        <li class="flex items-center text-gray-400 hover:text-gray-300">
            <!-- <NavLink :href="route('facilities.index')" :active="route().current('facilities.index')" class="flex items-center text-white"> -->
                ...
                <span class="ml-3" v-show="!hidden">Gallery</span>
            <!-- </NavLink> -->
        </li>
        <li class="flex items-center text-gray-400 hover:text-gray-300">
            <!-- <NavLink :href="route('facilities.index')" :active="route().current('facilities.index')" class="flex items-center text-white"> -->
                ...
                <span class="ml-3" v-show="!hidden">Contact Us</span>
            <!-- </NavLink> -->
        </li>
    </ul>
</template>
